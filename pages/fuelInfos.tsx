		...
		<ScrollView>
			...
			>
				<YStack paddingBottom={10} gap={5}>
					<XStack gap={10}>
						<Tabs.List>
							<Tabs.Tab
								...
								value="tab1"
							>
								<SizableText color={selected === "tab1" ? "white" : "black"}>Lista</SizableText>
							</Tabs.Tab>
							<Tabs.Tab
								...
								value="tab2"
							>
								<SizableText color={selected === "tab2" ? "white" : "black"}>Diagram</SizableText>
							</Tabs.Tab>
						</Tabs.List>
					...
					<XStack gap={10} alignItems="center" justifyContent="space-between" height={60}>
						<YStack flex={1}>
							<Button height={20} icon={Filter}>
								Kezdődátum:
							</Button>
							<Input flex={1} value={moment(startDate).format("YYYY-MM-DD")} onPressIn={() => openStartPicker()} />
						</YStack>
						<YStack flex={1}>
							<Button height={20} icon={Filter}>
								Végdátum:
							</Button>
							<Input flex={1} value={moment(endDate).format("YYYY-MM-DD")} onPressIn={() => openEndPicker()} />
						</YStack>
					</XStack>
				</YStack>
