...
import {Button, Card, H1, H2, H3, Paragraph, ScrollView, XStack, YStack} from "tamagui";
                ...
                <Card margin={10} borderRadius={20} key={car.id}>
                    <Card.Header padded>
                        <XStack justifyContent="space-between">
                            ...
                            <Button backgroundColor="transparent" size={80} alignSelf="center" icon={CarFront}>
                            </Button>
                        </XStack>
                    </Card.Header>
                    <Card.Footer padded>
                        <YStack width="100%" gap={5}>
                            ...
                            <XStack width="100%" justifyContent="space-between" gap={5}>
                                ...
                                <Button onPress={()=>removeCar(car.id, refetch)} color="red"  alignSelf="center" icon={Trash}>
                                    Törlés
                                </Button>
                            </XStack>
                        </YStack>
