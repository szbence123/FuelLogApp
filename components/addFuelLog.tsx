...
function AddFuelLog({carId}) {
    ...
    return (
        <Modal title="Tankolás hozzáadása" openBtn={
            <Button style={styles.primary} width="100%" alignSelf="center" icon={Fuel}>
                Tankolás hozzáadása
            </Button>
        } body = {
            <View>
                <YStack gap={10}>
                    ...
                    <Fieldset horizontal>
                        <Input onChangeText={setAmount} flex={1} id="amount" placeholder="Tankolt mennyiség" />
                    </Fieldset>
                    <Fieldset horizontal>
